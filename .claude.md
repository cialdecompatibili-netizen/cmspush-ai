...
### ✅ PROSSIMA SESSIONE — Tab Articoli stile WordPress (priorità alta)
**Richiesta:** Sostituire il layout attuale (lista sotto al form) con 2 viste separate:
- **Vista lista** (default): mostra solo gli articoli pubblicati, bottone "+ Nuovo articolo"
- **Vista editor**: apre il form editor a tutta larghezza, bottone "← Indietro" torna alla lista
- Modifica e Nuovo entrambi aprono la vista editor
- Le 2 viste si alternano con display:none/block — zero pagine separate
- Effetto identico a WordPress admin
- **File da modificare:** `admin/index.html` — sezione `<!-- ARTICOLI -->`
- **Metodo push:** PowerShell git (file >20KB)
